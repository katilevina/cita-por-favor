...
в буфер обмена одним кликом.

![Файл в репозитории и кнопка «Copy raw file»](img/setup-06-repo-file.png)

Код открывается прямо в браузере. Проверьте, что это нужный файл: в первых
строках видно имя **Cita Por Favor** и актуальную версию; личных данных в
коде нет — они вводятся позже через панель скрипта.

![Код cita-autofill.user.js прямо на GitHub](img/setup-06b-code-view.png)
...
![Raw-просмотр файла: кнопка «Copy raw file» сверху](img/setup-07-raw.png)
